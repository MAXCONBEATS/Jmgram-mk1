...
public class ContactController : ControllerBase
{
    ...
    public ContactController(CreateContactRequestUseCase createContactRequestUseCase, AcceptContactRequestUseCase acceptContactRequestUseCase, IHttpContextAccessor httpContextAccessor, ILogger<ContactController> logger) // Update constructor
    {
        ...
        _acceptContactRequestUseCase = acceptContactRequestUseCase ?? throw new ArgumentNullException(nameof(acceptContactRequestUseCase)); // Initialize
